<nav class="bbg-black p-5">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        <a href="https://flowbite.com/" class="flex items-center">

            <span
                class="self-center text-3xl font-semibold whitespace-nowrap text-red-600 hover:text-red-700">PentaFlix</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul
                ...
                <li>
                    <a href="/"
                        class="{{ Request::is('/') ? 'text-white block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-red-700 md:p-0 md:dark:text-red-500' : 'text-white block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-white md:p-0 md:dark:text-white'}}"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <a href="/films" class="{{ Request::is('/films') ? 'text-white block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-red-700 md:p-0 md:dark:text-red-500' : 'text-white block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-white md:p-0 md:dark:text-white'}}">All Films</a>
                </li>
            </ul>
        </div>
    </div>
